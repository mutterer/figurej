...
public abstract class Panel implements Serializable, PanelInterface {
	...
	public boolean canSetW(final int w) {
		return w < Panel.minLeafSideLength;
	}
	...
	public boolean canSetH(final int h) {
		return h < Panel.minLeafSideLength;
	}
	...
	protected boolean canSetX0PreservingX1(final int x0) {
		return xPos + panelWidth - x0 < Panel.minLeafSideLength;
	}
	...
	protected boolean canSetY0PreservingY1(final int y0) {
		return yPos + panelHeight - y0 < Panel.minLeafSideLength;
	}
