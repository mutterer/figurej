...
public class MyImageMath {
	...
	public static int[] getPixels(ImagePlus openImage, PolygonRoi boundingRect,
		...
		// some software, eg qpath, set pixelDepth to NaN when pixelDepth is unknown or irrelevant.
        if( Double.isNaN(imp.getCalibration().pixelDepth)) imp.getCalibration().pixelDepth = 1.0;
