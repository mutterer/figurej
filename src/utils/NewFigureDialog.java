...
public class NewFigureDialog  {
	...
	public boolean openDialog() {
		...
		gd.setLocation(260, ijBonds.y + ijBonds.height + 30);
;
		// show the dialog
		gd.showDialog();
		if (gd.wasCanceled()) 
		...
		// setup a sensible? default for font size
		TextRoi.setFont("sansserif",10*(int)(1+height/200),Font.PLAIN, true);
		Prefs.set("figure.defaultfontsize", 10*(int)(1+height/200));
		if ((width > 0) && (height > 0)) 
			return true;
