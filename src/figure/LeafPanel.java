...
public class LeafPanel extends Panel {
	...
	private void updateMetadata() {
		...
		if (imp != null) {
			...
			imp.setProp("panels", imp.getProp("panels")+panelRoi+"\n");
	...
	public ImagePlus getPanelPixels() {
		ImageProcessor ip = new ColorProcessor(getW(), getH(), myPanelPixels);
	...
	public Roi getHighlightROI() {
		...
		r.setStrokeColor(Colors.decode("#ff00ff00", null));
		r.setStrokeWidth(separatorWidth);
		return r;
	}
	...
	public void setLabel(ImagePlus resultFigure, String text, int xOffset,
		...
		labelFont = new Font(TextRoi.getDefaultFontName(), TextRoi.getDefaultFontStyle(),
				TextRoi.getDefaultFontSize());
	...
	public void moveScalebar(ImagePlus imp) {
		...
		ip.setFont(this.getScaleBarTextFont()!=null?this.getScaleBarTextFont():new Font(TextRoi.getDefaultFontName(), TextRoi.getDefaultFontStyle(),
				TextRoi.getDefaultFontSize()));
